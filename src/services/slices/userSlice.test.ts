...
describe('test user', () => {
  ...
  test('test get user auth rejected', () => {
    const newState = userSliceReducer(
      ...
      getUserAuth.rejected(new Error('error'), 'test_id')
    );
  ...
  test('test get user auth fulfilled', () => {
    const newState = userSliceReducer(
      ...
      getUserAuth.fulfilled(userResponse, 'test_id')
    );
  ...
  test('test login user pending', () => {
    const newState = userSliceReducer(
      initialState,
      loginUser.pending('loading', registerData)
    );
  ...
  test('test login user rejected', () => {
    const newState = userSliceReducer(
      initialStateRejected,
      loginUser.rejected(new Error('error'), 'test_id', registerData)
    );
  ...
  test('test login user fulfilled', () => {
    const newState = userSliceReducer(
      initialStateFulfilled,
      loginUser.fulfilled(actualAuthResponse, 'test_id', registerData)
    );
  ...
  test('test register user pending', () => {
    const newState = userSliceReducer(
      initialState,
      registerUser.pending('loading', registerDataName)
    );
  ...
  test('test register user rejected', () => {
    const newState = userSliceReducer(
      initialStateRejected,
      registerUser.rejected(new Error('error'), 'test_id', registerDataName)
    );
  ...
  test('test register user fulfilled', () => {
    const newState = userSliceReducer(
      initialStateFulfilled,
      registerUser.fulfilled(actualAuthResponse, 'test_id', registerDataName)
    );
  ...
  test('test update user data pending', () => {
    const newState = userSliceReducer(
      initialState,
      updateUserData.pending('loading', registerData)
    );
  ...
  test('test update user data rejected', () => {
    const newState = userSliceReducer(
      initialStateRejected,
      updateUserData.rejected(new Error('error'), 'test_id', registerData)
    );
  ...
  test('test update user data fulfilled', () => {
    const newState = userSliceReducer(
      initialStateFulfilled,
      updateUserData.fulfilled(userResponse, 'test_id', registerData)
    );
  ...
  test('test user logout rejected', () => {
    const newState = userSliceReducer(
      initialStateRejected,
      userLogout.rejected(new Error('error'), 'test_id')
    );
  ...
  test('test user logout fulfilled', () => {
    const newState = userSliceReducer(
      initialStateFulfilled,
      userLogout.fulfilled({ success: true }, 'test_id')
    );
